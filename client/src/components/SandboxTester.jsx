...
import { Sparkles, Play, RefreshCw, AlertTriangle, CheckCircle2, ArrowRight } from 'lucide-react';
import GeoDistanceMap from './GeoDistanceMap.jsx';

export default function SandboxTester() {
  const [projA, setProjA] = useState({
    id: 'CUSTOM-PROJ-A',
    title: 'Construction of community hall in Village X',
    description: 'Construction of community hall for civic assemblies and gatherings in Village X.',
    category: 'Community Infrastructure',
    sanction_amount: 1500000,
    coordinates: { lat: 25.3176, lng: 82.9739 },
    execution_start: '2024-01-15',
  ...
  const [projB, setProjB] = useState({
    ...
    description: 'Development of public community centre building in Village X area.',
    category: 'Community Infrastructure',
    sanction_amount: 1450000,
    coordinates: { lat: 25.3180, lng: 82.9741 },
    execution_start: '2024-05-01',
    execution_end: '2024-12-31'
  });
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-8 shadow-xl border border-indigo-900/50">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-2xl font-black text-slate-100">Live AI Duplicate Tester & Simulator</h2>
